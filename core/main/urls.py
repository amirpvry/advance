...
from .views import (home_view,about_view,trademark,online_service,copyright_view,design_view,
                    ipserver_view,translation_view,fa_copyright_view,homepage_view,services_view,
                    about_us_view,contact_us_view)
app_name = "main"
